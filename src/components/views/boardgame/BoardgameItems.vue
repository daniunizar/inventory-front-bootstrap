    ...
    <main class="container mt-5">
      <h1 class="text-center mb-5">Mi Ludoteca</h1>
       <div class="d-flex justify-content-between">
        <router-link :to="{name: 'boardgame.item.store'}" class="btn btn-primary">Buscar nuevo juego en mi colección</router-link>
        <router-link :to="{name: 'boardgame.item.create'}" class="btn btn-primary">Registrar nuevo juego en mi colección</router-link>
